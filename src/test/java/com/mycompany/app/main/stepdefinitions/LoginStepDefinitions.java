...
public class LoginStepDefinitions {
    ...
    @Given("^Michael es un cliente que quiere iniciar sesion para administrar sus productos$")
    public void michael_es_un_cliente_que_quiere_iniciar_sesion_para_administrar_sus_productos() {
    }
